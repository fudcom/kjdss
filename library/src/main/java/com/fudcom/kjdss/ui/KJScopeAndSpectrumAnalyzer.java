...
import com.fudcom.kjdss.KJDigitalSignalProcessor;
...
//				wLas );
	 ...
	 */
	public void initialize( int pSampleSize, AudioFormat pAudioFormat ) {
		
		setSpectrumAnalyserSampleSizeAndRate( 
			pSampleSize,
			pAudioFormat.getSampleRate() );
		
		oldVolume = new float[ pAudioFormat.getChannels() ];
